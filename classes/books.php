...
class books {
    ...
    public function __construct($isbn, $title, $publisher, $year, $age_restriction, $edition, $is_reference, $original_price, $accessibility_options_id, $genre_id, $reader_level_id) {
        $this->isbn = $isbn;
        $this->title = $title;
